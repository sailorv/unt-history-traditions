...
http://foundation.zurb.com/docs/faq.php or use the script in the unt_foundation
...
----------------------
 ...
 1. Setup the location for your new sub-theme.
    ...
    Copy the unt_foundation folder out of the zurb_foundation/ folder and rename it to
    ...
    For example, copy the themes/zurb_foundation/unt_foundation folder and
 ...
 2. Setup the basic information for your sub-theme.
    ...
    In your new sub-theme folder, rename the unt_foundation.info.yml.txt file to
    ...
    For example, rename the foo/unt_foundation.info.yml.txt file to foo/foo.info.yml.
    Edit the foo.info.yml file and change "name: Foundation Sub-theme unt_foundation"
 ...
 3. Edit your sub-theme to use the proper function names.
    ...
    First, rename unt_foundation.theme to include the name of your new sub-theme. In
    this example we'll assume that it's renamed foo.theme.

    Edit the foo.theme and theme-settings.php files in your sub-theme's
    folder; replace ALL occurrences of "unt_foundation" with the name of your
    sub-theme.

    For example, edit foo/foo.theme and foo/theme-settings.php and replace
    every occurrence of "unt_foundation" with "foo".
...
Optional steps:
 ...
 9. Add custom css and js files to your sub-theme
    ...
    Rename unt_foundation.libraries.yml to the name of your sub-theme, un-commenting
